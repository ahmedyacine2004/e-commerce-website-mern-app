...
function ProductItem({ product }) {
  ...
  return (
    <div className="productItem rounded-md overflow-hidden border-[1px] bg-[#f1f1f1] shadow-lg border-primary">
      ...
      <div className="group imgWrapper w-[100%] rounded-md overflow-hidden relative transition-all">
        {/* Image Container */}
        <div
          className="img h-[220px] overflow-hidden"
      ...
      <div className="info !text-black p-3">
        ...
        {/* Name / Title */}
        <h3 className="title link text-start text-[18px] font-[600] mb-2 min-h-[50px]">
